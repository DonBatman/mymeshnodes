...
local o45_cbox = {
	...
	fixed = {
			...
			{0.375, -0.5, -0.25, 0.5, -0.125, 0.5},
			{0.375, -0.5, -0.125, 0.5, 0, 0.5},
			{0.375, -0.5, 0, 0.5, 0.125, 0.5},
			{0.375, -0.5, 0.125, 0.5, 0.25, 0.5},
			{0.375, -0.5, 0.25, 0.5, 0.375, 0.5},
			{0.375, -0.5, 0.375, 0.5, 0.5, 0.5},
			{-0.5, -0.5, 0.375, 0.5, -0.375, 0.5},
			{-0.375, -0.5, 0.375, 0.5, -0.25, 0.5},
			{-0.25, -0.5, 0.375, 0.5, -0.125, 0.5},
			{-0.125, -0.5, 0.375, 0.5, 0, 0.5},
			{0, -0.5, 0.375, 0.5, 0.125, 0.5},
			{0.125, -0.5, 0.375, 0.5, 0.25, 0.5},
			{0.25, -0.5, 0.375, 0.5, 0.375, 0.5},
			{-0.375, -0.5, 0.25, 0.5, -0.375, 0.5},
			{-0.25, -0.5, 0.125, 0.5, -0.375, 0.5},
			{-0.125, -0.5, 0, 0.5, -0.375, 0.5},
			{0, -0.5, -0.125, 0.5, -0.375, 0.5},
			{0.125, -0.5, -0.25, 0.5, -0.375, 0.5},
			{0.25, -0.5, -0.375, 0.5, -0.375, 0.5},
			{-0.25, -0.5, 0.25, 0.5, -0.25, 0.5},
			{-0.125, -0.5, 0.125, 0.5, -0.25, 0.5},
			{0, -0.5, 0, 0.5, -0.25, 0.5},
			{0.125, -0.5, -0.125, 0.5, -0.25, 0.5},
			{0.25, -0.5, -0.25, 0.5, -0.25, 0.5},
			{-0.125, -0.5, 0.25, 0.5, -0.125, 0.5},
			{0, -0.5, 0.125, 0.5, -0.125, 0.5},
			{0.125, -0.5, 0, 0.5, -0.125, 0.5},
			{0.25, -0.5, -0.125, 0.5, -0.125, 0.5},
			{0, -0.5, 0.25, 0.5, 0, 0.5},
			{0.125, -0.5, 0.125, 0.5, 0, 0.5},
