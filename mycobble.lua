...
local hard_slopes = {   --Material  Image
	{ "desert_gravel",			"default_gravel.png^[colorize:#8A2908:120"},
	{ "sandstone_gravel",		"default_gravel.png^[colorize:#e3e3ae:120"},
	{ "sandstone_sand",			"default_sand.png^[colorize:#e3e3ae:120"},
	{ "silver_gravel",			"default_gravel.png^[colorize:#c8c8c1:120"},
	{ "silver_cobble",			"default_cobble.png^[colorize:#c8c8c1:120"},
	{ "sandstone_cobble",		"default_cobble.png^[colorize:#e1da94:120"},
	{ "desert_sandstone_cobble","default_cobble.png^[colorize:#f4b05c:120"},
	{ "desert_sandstone_gravel","default_gravel.png^[colorize:#f4b05c:120"},
	{ "desert_sandstone_sand",	"default_sand.png^[colorize:#ef8a3d:120"},
}
