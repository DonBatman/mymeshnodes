...
local bat_slopes = {   --Material , Description , Item, Image
	{ "slate" ,          "Slate" ,            "ores:slate",              "ores_slate.png"},
--	{ "slate_brick" ,          "Slate Brick" ,            "ores:slate_brick",              "ores_slate_brick.png"},
--	{ "slate_tile" ,          "Slate Tile" ,            "ores:slate_tile",              "ores_slate_tile.png"},
--	{ "slate_tiles" ,          "Slate Tiles" ,            "ores:slate_tiles",              "ores_slate_tiles.png"},
--	{ "slate_splitstone" ,          "Slate Splitstone" ,            "ores:slate_splitstone",              "ores_slate_splitstone.png"},
	{ "silt" ,          "Silt" ,            "ores:silt",              "ores_silt.png"},
	{ "shale" ,          "Shale" ,            "ores:shale",              "ores_shale.png"},
	{ "schist" ,          "Schist" ,            "ores:schist",              "ores_schist.png"},
	{ "redsandstone" ,          "Red Sandstone" ,            "ores:redsandstone",              "ores_redsandstone.png"},
	{ "gneiss" ,          "Gneiss" ,            "ores:gneiss",              "ores_gneiss.png"},
	{ "basalt" ,          "Basalt" ,            "ores:basalt",              "ores_basalt.png"},
	{ "granite" ,          "Granite" ,            "ores:granite",              "ores_granite.png"},
	{ "marble" ,          "Marble" ,            "ores:marble",              "ores_marble.png"},
}
